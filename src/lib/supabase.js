...
exports.supabaseAdmin = (0, supabase_js_1.createClient)(supabaseUrl, import.meta.env.VITE_SUPABASE_SERVICE_KEY, {
    auth: {
    ...
    global: {
        headers: {
            'Authorization': "Bearer ".concat(import.meta.env.VITE_SUPABASE_SERVICE_KEY)
        }
    }
});
/**
